...
import React, { useState } from 'react'
import { MoveRight, Loader2, Search, ArrowUp, ChevronDown, ChevronUp } from "lucide-react";
import { useEffect, useRef } from 'react';
import gsap from 'gsap';
import { Sparklines, SparklinesLine } from "react-sparklines";
import { indianStocks } from "../../data/stocks.js";
import { stocksdata } from "../../data/herodata.js";
import PredictionResults from "./PredictionResults.jsx";


const API_BASE_URL = 'https://real-pleasantly-grizzly.ngrok-free.app';


const PredictionHero = ({ setPredictionData }) => {
  ...
  const random8Stocks1 = [...stocksdata]
    .sort(() => Math.random() - 0.5)
    .slice(0, 5);

  const random8Stocks2 = [...stocksdata]
    .sort(() => Math.random() - 0.5)
    .slice(0, 5);

  const random8Stocks3 = [...stocksdata]
    .sort(() => Math.random() - 0.5)
    .slice(0, 5);

  const random8Stocks4 = [...stocksdata]
    .sort(() => Math.random() - 0.5)
    .slice(0, 5);

  const random8Stocks5 = [...stocksdata]
    .sort(() => Math.random() - 0.5)
    .slice(0, 5);

  const random8Stocks6 = [...stocksdata]
    .sort(() => Math.random() - 0.5)
    .slice(0, 5);

  return (
    // <div className='relative z-10 w-full h-screen flex flex-col justify-start items-center bg-black'>

    <div className='relative z-10 w-full min-h-screen flex flex-col items-center bg-black overflow-x-hidden'>

      <div className="absolute z-10 px-5 flex items-end justify-center gap-4 bottom-0 h-[900px] overflow-hidden">

        <div className="space-y-3 relative top-35 ">
          {random8Stocks1.map((stock, index) => {
            const isUp = stock.trend === "up";
            const gradientClass = isUp
              ? "bg-gradient-to-t from-green-500/20 via-green-500/10 to-transparent"
              : "bg-gradient-to-t from-red-500/20 via-red-500/10 to-transparent";
            const strokeColor = isUp ? "#22c55e" : "#ef4444";

            return (
              <div
                key={`${stock.ticker}-${index}`}
                className={`flex flex-col gap-2 rounded-xl border-2 border-white/20 p-6 ${gradientClass}`}
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <div className="text-sm text-white syne">{stock.ticker}</div>
                  </div>

                  <div className="h-10 w-24 rounded-lg p-1">
                    <svg
                      viewBox="0 0 100 40"
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="text-white urbanist text-sm">{stock.name}</div>
        ...
        <div className="space-y-3 relative top-100 ">
          {random8Stocks2.map((stock, index) => {
            const isUp = stock.trend === "up";
            const gradientClass = isUp
              ? "bg-gradient-to-t from-green-500/20 via-green-500/10 to-transparent"
              : "bg-gradient-to-t from-red-500/20 via-red-500/10 to-transparent";
        ...
        <div className="space-y-3 relative top-115 ">
          {random8Stocks3.map((stock, index) => {
            const isUp = stock.trend === "up";
            const gradientClass = isUp
              ? "bg-gradient-to-t from-green-500/20 via-green-500/10 to-transparent"
              : "bg-gradient-to-t from-red-500/20 via-red-500/10 to-transparent";
        ...
        <div className="space-y-3 relative top-80">
          {random8Stocks4.map((stock, index) => {
            const isUp = stock.trend === "up";
            const gradientClass = isUp
              ? "bg-gradient-to-t from-green-500/20 via-green-500/10 to-transparent"
              : "bg-gradient-to-t from-red-500/20 via-red-500/10 to-transparent";
        ...
        <div className="space-y-3 relative top-95">
          {random8Stocks5.map((stock, index) => {
            const isUp = stock.trend === "up";
            const gradientClass = isUp
              ? "bg-gradient-to-t from-green-500/20 via-green-500/10 to-transparent"
              : "bg-gradient-to-t from-red-500/20 via-red-500/10 to-transparent";
        ...
        <div className="space-y-3 relative top-25">
          {random8Stocks6.map((stock, index) => {
            const isUp = stock.trend === "up";
            const gradientClass = isUp
              ? "bg-gradient-to-t from-green-500/20 via-green-500/10 to-transparent"
              : "bg-gradient-to-t from-red-500/20 via-red-500/10 to-transparent";
      ...
      <div className='w-full flex justify-center items-center '>
        <div
          className="relative z-20 flex flex-col items-center justify-center gap-2 text-white mt-40">
          <div
            ref={textRef}
            className='syne text-5xl max-w-[1200px] text-center flex items-center gap-2'>
            <span>Know the Likely Move Before You</span>
